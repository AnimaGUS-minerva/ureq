...
pub(crate) fn connect_inner_with_stream(
    unit: &Unit,
    is_recycled: bool,
    body: SizedReader,
    history: &[Url],
...
pub(crate) fn can_propagate_authorization_on_redirect(
...
pub(crate) fn send_prelude(unit: &Unit, stream: &mut Stream) -> io::Result<()> {
